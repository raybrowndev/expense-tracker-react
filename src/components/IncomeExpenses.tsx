        ...
        <div className="max-w-md mx-auto bg-white border-0 rounded-lg shadow-inner shadow-md p-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="income flex flex-col items-center">
              <h2 id="money-plus" className="money-plus text-xl font-bold text-slate-800">Income</h2>
              <MoneyLargeIncome value={3400.11} />
            </div>
            <div className="expense flex flex-col items-center">
              <h2 id="money-minus" className="money-minus text-xl font-bold text-slate-800">Expense</h2>
